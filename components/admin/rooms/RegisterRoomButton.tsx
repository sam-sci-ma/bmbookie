...
import { X, Plus, Users, ShieldCheck, ShieldAlert, Loader2, UploadCloud, Image as ImageIcon } from "lucide-react";
...
export default function RegisterRoomModal({ isOpen, onClose }: RegisterRoomModalProps) {
  ...
  const resetForm = () => {
    setFormData({
        ...
        location: "", floor: "", campus: "Benguerir", is_restricted: false
      });
      setImageFile(null);
